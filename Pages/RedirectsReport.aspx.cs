...
namespace Sitecore.SharedSource.RedirectManager.Pages
{
    ...
    public partial class RedirectsReport : System.Web.UI.Page
    {
        ...
        private static string BuildRegExNodeName(RegExRedirect item)
        {
            ...
            return string.Format(
                  "<div class=\"block-name\">" +
                    ...
                    "<div class=\"title\">Expression: {2}, Value: {3}</div>" +
                  "</div>" +
                  "<div class=\"description\">Redirect Code: {4}, Last Use: {5}, ID: {1}</div>",
                  item.Name,
                  item.ID,
        ...
        private void GenerateReport()
        {
            ...
            AddChildNodes(rootNode, rootItem);
            Redirects.Nodes.Add(rootNode);
        }
